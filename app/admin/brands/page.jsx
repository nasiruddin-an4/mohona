      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-2">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm font-medium text-gray-500 mt-1">Manage your product brands</p>
          </div>
          <button 
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[13px]">
              <thead className="text-gray-900 font-bold border-b border-gray-100 bg-gray-50/50">
                <tr>
                  <th className="px-6 py-4 w-[80%]">Brand Details</th>
                    ...
                    <tr key={brand._id} className="hover:bg-gray-50/50 transition-colors group">
                      <td className="px-6 py-4">
                        <div className="flex items-start gap-4">
                          <div className="w-10 h-10 rounded-xl bg-purple-50 flex items-center justify-center text-purple-500 shrink-0 mt-1 group-hover:scale-110 transition-transform">
                          ...
                          <div>
                            ...
                            <p className="text-gray-500 text-xs leading-relaxed max-w-sm line-clamp-2">
                              {brand.description || <span className="italic text-gray-400">No description provided</span>}
                            </p>
                          </div>
                        </div>
                      </td>
