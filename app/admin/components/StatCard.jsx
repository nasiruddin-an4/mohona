...
export default function StatCard({ title, value, percentage, trend, bg, textPrefix = '' }) {
  ...
  return (
    <div className={`${bg} rounded-xl p-5 flex flex-col justify-between h-[130px] relative overflow-hidden transition-transform hover:-translate-y-1 duration-300 border border-black/5`}>
