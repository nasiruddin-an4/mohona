    ...
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-[50%] flex flex-col pt-2 lg:pl-10 pr-4 lg:pr-10">
          ...
          <a
            href={`https://wa.me/8801769441085?text=${encodeURIComponent(`Hi, I'm interested in ordering:\n\n📦 *${product.productId?.name || product.name}*\n🏷️ SKU: ${displaySku}\n💰 Price: ৳${(product.price || product.unit_price || 0).toFixed(2)}\n\nPlease share more details.`)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full bg-[#25D366] hover:bg-[#1fb855] text-white font-medium py-3.5 transition-colors flex items-center justify-center gap-2 mb-8 rounded-lg"
          >
