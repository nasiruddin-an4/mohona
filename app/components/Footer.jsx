              ...
              <div key={feature.id} className="flex flex-col items-center text-center px-6 py-12">
                {feature.isSocial ? (
                  <div className="flex items-center justify-center gap-3 mb-6 w-full">
                    ...
                    <div className="w-8 h-8 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 rounded-sm flex items-center justify-center text-white">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
                    </div>
                    <div className="w-8 h-8 bg-red-600 rounded-sm flex items-center justify-center text-white">
      ...
      <div className="bg-black py-4">
        <div className="container mx-auto px-4 text-center">
          <p className="text-xs text-gray-300 font-medium">
            © {new Date().getFullYear()} Mohona by CGFWA. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
