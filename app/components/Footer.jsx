  ...
  const features = [
    {
      ...
      icon: <Truck size={36} strokeWidth={1.5} className="mb-4 text-gray-300" />,
      link: "#"
    },
    {
      id: 2,
      ...
      icon: <Megaphone size={36} strokeWidth={1.5} className="mb-4 text-gray-300" />,
      link: "#"
    },
    {
      id: 3,
      ...
      icon: <Award size={36} strokeWidth={1.5} className="mb-4 text-gray-300" />,
      link: "#"
    },
    {
      id: 4,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 lg:pr-8">
            <h4 className="font-bold text-white mb-4 text-sm">Sign up and Stay Updated</h4>
            ...
            <form className="flex w-full">
              <input
                ...
                className="flex-1 bg-slate-800 border border-slate-700 rounded-l-sm px-4 py-2.5 text-sm focus:outline-none focus:border-gray-500 text-white placeholder-gray-500"
                required
              />
              <button
                type="submit"
                className="bg-white hover:bg-gray-200 text-black px-5 py-2.5 rounded-r-sm transition-colors flex items-center justify-center"
              >
                <ArrowRight size={18} />
              </button>
            </form>
          ...
          <div className="lg:col-span-2 lg:col-start-6 flex flex-col lg:items-center">
            <div className="w-full lg:w-auto">
              <h4 className="font-bold text-white mb-6 text-sm">About Mohona</h4>
          ...
          <div className="lg:col-span-2 flex flex-col lg:items-center">
            <div className="w-full lg:w-auto">
              <h4 className="font-bold text-white mb-6 text-sm">Help</h4>
              <ul className="space-y-3">
          ...
          <div className="lg:col-span-3 flex flex-col lg:items-end">
            <div className="w-full max-w-[200px]">
              ...
              <div className="grid grid-cols-3 gap-3 w-full">
                <div className="bg-white h-10 rounded flex items-center justify-center text-blue-800 font-bold text-[10px] italic">VISA</div>
                <div className="bg-white h-10 rounded flex items-center justify-center text-red-500 font-bold text-[10px]">MasterCard</div>
                <div className="bg-white h-10 rounded flex items-center justify-center text-blue-600 font-bold text-[10px]">AMEX</div>
                <div className="bg-white h-10 rounded flex items-center justify-center text-pink-600 font-bold text-[10px]">bKash</div>
                <div className="bg-white h-10 rounded flex items-center justify-center text-orange-500 font-bold text-[10px]">Nagad</div>
                <div className="bg-white h-10 rounded flex items-center justify-center text-purple-600 font-bold text-[10px]">Rocket</div>
              </div>
            </div>
          </div>
